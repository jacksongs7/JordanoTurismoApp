...
import { Reservation } from '@/types'; // Caminho corrigido
import Header from '@/components/Header'; // Caminho corrigido
import { isAuthenticated, getToken, logout } from '@/services/AuthService'; // Caminho corrigido
import { fetchUserReservations } from '@/services/ApiService'; // Caminho corrigido
