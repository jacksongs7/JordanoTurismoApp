...
// import { createReservation } from '@/services/ApiService'; // Esta linha não é mais necessária aqui, pois a reserva é tratada em 'reserveForm'
...
export default function TourDetailScreen() {
  ...
  const handleReservePress = async () => {
    ...
    if (!token) {
      ...
      // Redireciona para o formulário de reserva em vez de criar a reserva diretamente aqui
      router.push({
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        {/* CORREÇÃO APLICADA AQUI: Removido { uri: tour.image } */}
