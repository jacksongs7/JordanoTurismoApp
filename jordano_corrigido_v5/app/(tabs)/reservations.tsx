...
import { Reservation } from '@/app/_lib/types';             // Caminho ajustado
import Header from '@/app/_lib/components/Header';         // Caminho ajustado
import { isAuthenticated, getToken, logout } from '@/app/_lib/services/AuthService'; // Caminho ajustado
import { fetchUserReservations } from '@/app/_lib/services/ApiService'; // Caminho ajustado
  ...
  const loadReservations = async () => {
    ...
    if (!authenticated) {
      Alert.alert(
        ...
        [
          { text: 'Cancelar', style: 'cancel', onPress: () => router.replace('/') },
