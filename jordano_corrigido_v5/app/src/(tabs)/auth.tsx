...
import AuthInput from '@/src/components/AuthInput'; // Caminho ajustado
import { login, register } from '@/src/services/AuthService'; // Caminho ajustado
import Logo from '../../assets/images/LOGO-JT.png'; // Caminho ajustado
